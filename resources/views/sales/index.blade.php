                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Satışlar</h4>
                                    ...
                                    <a href="{{route('sales.create')}}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        @foreach($sales as $sale)
                                            <tr>
                                                ...
                                                <td>{{$sale->contract}}</td>
                                                <td>{{$sale->date}}</td>
                                                <td style="color: {{ \App\Enums\Status::getStatusColor($sale->status) }};">{{ \App\Enums\Status::getStatusLabel($sale->status) }}</td>
