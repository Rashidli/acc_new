    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('reports.update', $report->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$report->report_number}}</h4>
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control js-example-basic-single" type="text" name="company" id="company">
                                        ...
                                        @foreach($ins as $c)
                                            <option value="{{$c->title}}" {{$report->company == $c->title ? 'selected' : ''}}>{{$c->title}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control js-example-basic-single" type="text" name="income_number" id="corporate_name">
                                        <option selected disabled>----- </option>
                                        @foreach($wares as $c)
                                            <option value="{{$c->income_number}}" {{$report->income_number == $c->income_number ? 'selected' : ''}}>{{$c->income_number}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control js-example-basic-single" type="text" name="debet" id="debet">
                                        ...
                                        @foreach($debet_credits as $c)
                                            <option value="{{$c->number}}" {{$report->debet == $c->number ? 'selected' : ''}}>{{$c->number}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control js-example-basic-single" type="text" name="credit" id="credit">
                                        <option selected disabled>----- </option>
                                        @foreach($debet_credits as $c)
                                            <option value="{{$c->number}}" {{$report->credit == $c->number ? 'selected' : ''}}>{{$c->number}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$report->date}}" class="form-control" type="date" name="date">
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$report->electron_invoice}}" class="form-control" type="text" name="electron_invoice">
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <input value="{{$report->test_price}}" class="form-control" type="text" name="test_price">
                            ...
                            <div class="col-12">
                                ...
                                @livewire('report-products', ['report' => $report])
