                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Invoices</h4>
                                    ...
                                    <a href="{{route('invoices.create')}}" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
...
{{--                                                <th>Quotation</th>--}}
                                        ...
                                        @foreach($invoices as $invoice)
                                            <tr>
                                                ...
                                                <td><input type="radio" class="radio_input" name="check" data-edit="{{route('invoices.edit',$invoice->id)}}" data-delete="{{route('invoices.destroy', $invoice->id)}}"></td>
